# Feature Tasks: 005-realtime-dashboard
...
- [ ] T001: Create `tests/e2e/dashboard/daily-ops.spec.ts`
- [ ] T002: Implement "Check-in" flow test
...
- [ ] T004: Add client-side polling or manual refresh button to `DashboardPage`.
