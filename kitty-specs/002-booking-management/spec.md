...
*   **FR-07:** Step 3: Select Guest (Search existing or Create new - *Dependency on Feature 003, but will stub simple inputs for now*).
...
*   **Timezones:** Store dates as UTC midnight (or property local midnight). *Decision: Store as DateTime at noon property time to avoid timezone edge cases, or strict UTC.*
